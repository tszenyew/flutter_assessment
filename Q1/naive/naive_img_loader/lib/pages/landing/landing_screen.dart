...
class LandingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Naïve 1,000 Images')),
      body: Container(
        ...
        child: Column(
          ...
          spacing: 16,
          children: [
            const Text('This is a naïve implementation of a list with 1,000 images.'),
            const Text('It will likely cause performance issues due to rendering all images at once.'),
            Expanded(
              child: Column(
